...
MyCarStatus::MyCarStatus () {
    ...
    stanley_pid_pub = nh.advertise<only_going_forward::CarlaEgoVehicleControl>("/carla/ego_vehicle/vehicle_control_cmd", 100);
}


void MyCarStatus::GetData(const only_going_forward::CallbackMyCar::ConstPtr& msg) {
