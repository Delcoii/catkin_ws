...
MyCarStatus::MyCarStatus () {
    ...
    stanley_pid_pub = nh.advertise<stanley_method_v4::CarlaEgoVehicleControl>("/carla/ego_vehicle/vehicle_control_cmd", 100);
}


void MyCarStatus::GetData(const stanley_method_v4::CallbackMyCar::ConstPtr& msg) {
